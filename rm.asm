...
printint(int fd, int xx, int base, int sgn)
{
 ...
 377:	f7 f1                	div    %ecx
 379:	0f b6 92 3c 07 00 00 	movzbl 0x73c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 509:	89 44 24 0c          	mov    %eax,0xc(%esp)
        if(s == 0)
          s = "(null)";
 50d:	b8 35 07 00 00       	mov    $0x735,%eax
...
free(void *ap)
{
 ...
 5a7:	a1 84 0a 00 00       	mov    0xa84,%eax
void
free(void *ap)
{
  Header *bp, *p;
...
free(void *ap)
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 607:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60a:	a3 84 0a 00 00       	mov    %eax,0xa84
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 623:	8b 44 24 10          	mov    0x10(%esp),%eax
  if((prevp = freep) == 0){
 627:	8b 15 84 0a 00 00    	mov    0xa84,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 677:	76 3f                	jbe    6b8 <malloc+0x98>
    ...
    if(p == freep)
 679:	39 05 84 0a 00 00    	cmp    %eax,0xa84
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 84 0a 00 00    	mov    0xa84,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 6c4:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6c7:	89 15 84 0a 00 00    	mov    %edx,0xa84
      return (void*) (p + 1);
 ...
 6dc:	eb e9                	jmp    6c7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6de:	c7 05 84 0a 00 00 88 	movl   $0xa88,0xa84
 6e5:	0a 00 00 
 6e8:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 6ef:	0a 00 00 
    base.s.size = 0;
 6f2:	b8 88 0a 00 00       	mov    $0xa88,%eax
 6f7:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 6fe:	00 00 00 
