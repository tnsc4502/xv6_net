...
main(int argc, char **argv)
{
  ...
  36:	83 c3 01             	add    $0x1,%ebx
    kill(atoi(argv[i]));
  39:	e8 f2 01 00 00       	call   230 <atoi>
  3e:	89 04 24             	mov    %eax,(%esp)
  41:	e8 7b 02 00 00       	call   2c1 <kill>
  ...
  4b:	75 e3                	jne    30 <main+0x30>
    kill(atoi(argv[i]));
  exit();
  4d:	e8 3f 02 00 00       	call   291 <exit>
main(int argc, char **argv)
{
  int i;
  ...
  52:	50                   	push   %eax
  53:	50                   	push   %eax
  54:	68 f8 06 00 00       	push   $0x6f8
  59:	6a 02                	push   $0x2
  5b:	e8 70 03 00 00       	call   3d0 <printf>
    exit();
  60:	e8 2c 02 00 00       	call   291 <exit>
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 14 07 00 00 	movzbl 0x714(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4f9:	89 44 24 0c          	mov    %eax,0xc(%esp)
        if(s == 0)
          s = "(null)";
 4fd:	b8 0c 07 00 00       	mov    $0x70c,%eax
...
free(void *ap)
{
 ...
 597:	a1 5c 0a 00 00       	mov    0xa5c,%eax
void
free(void *ap)
{
  Header *bp, *p;
...
free(void *ap)
{
 ...
 5d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5d9:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 5de:	5b                   	pop    %ebx
 5df:	5e                   	pop    %esi
 5e0:	5f                   	pop    %edi
 ...
 5f7:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5fa:	a3 5c 0a 00 00       	mov    %eax,0xa5c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 613:	8b 44 24 10          	mov    0x10(%esp),%eax
  if((prevp = freep) == 0){
 617:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 667:	76 3f                	jbe    6a8 <malloc+0x98>
    ...
    if(p == freep)
 669:	39 05 5c 0a 00 00    	cmp    %eax,0xa5c
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 6b4:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6b7:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
      return (void*) (p + 1);
 ...
 6cc:	eb e9                	jmp    6b7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6ce:	c7 05 5c 0a 00 00 60 	movl   $0xa60,0xa5c
 6d5:	0a 00 00 
 6d8:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 6df:	0a 00 00 
    base.s.size = 0;
 6e2:	b8 60 0a 00 00       	mov    $0xa60,%eax
 6e7:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 6ee:	00 00 00 
